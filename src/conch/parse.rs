...
use crate::conch::ast::builder::ComplexWordKind::{self, Concat, Single};
use crate::conch::ast::builder::WordKind::{self, DoubleQuoted, Simple, SingleQuoted};
use crate::conch::ast::builder::{self, Builder, SimpleWordKind};
use crate::conch::ast::{self, DefaultArithmetic, DefaultParameter};
...
impl<I: Iterator<Item = Token>, B: Builder> Parser<I, B> {
    ...
    pub fn simple_command(&mut self) -> ParseResult<B::PipeableCommand, B::Error> {
        use crate::conch::ast::{RedirectOrCmdWord, RedirectOrEnvVar};
    ...
    fn parameter_substitution_body_raw(
        ...
        use crate::conch::ast::builder::ParameterSubstitutionKind::*;
        use crate::conch::ast::Parameter;
    ...
    fn arith_assig(&mut self) -> ParseResult<DefaultArithmetic, B::Error> {
        use crate::conch::ast::Arithmetic::*;
...
#[cfg(test)]
mod tests {
    use crate::conch::ast::builder::Newline;
    use crate::conch::ast::Command::*;
    use crate::conch::ast::CompoundCommandKind::*;
    use crate::conch::ast::*;
    use crate::conch::lexer::Lexer;
    use crate::conch::parse::*;
